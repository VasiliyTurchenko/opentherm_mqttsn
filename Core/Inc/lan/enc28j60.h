...
#define		USE_HAL_DMA_SPI
#ifndef		USE_HAL_DMA_SPI
  #define	USE_HAL_IO_SPI
#endif  
...
#define	MIN_ETH_FRAME_SIZE	(uint16_t)64
...
#define ENC28J60_SPI_RCR	0x00u
#define ENC28J60_SPI_RBM	0x3Au
#define ENC28J60_SPI_WCR	0x40u
#define ENC28J60_SPI_WBM	0x7Au
#define ENC28J60_SPI_BFS	0x80u
#define ENC28J60_SPI_BFC	0xA0u
#define ENC28J60_SPI_SC		0xFFu

#define ENC28J60_ADDR_MASK	0x1Fu
#define ENC28J60_COMMON_CR	0x1Bu
...
// MII registers
#define MICMD 				(0x12u | 0x40u | 0x80u)
...
// MICON
#define MICON_RSTMII		0x80u

// MICMD
#define MICMD_MIISCAN		0x02u
